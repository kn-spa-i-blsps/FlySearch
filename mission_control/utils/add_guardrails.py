...
def meters_per_pixel(width: int, camera_fov_degrees: float, drone_height: float) -> float:
...
def compute_grid_points(width, height, w_dots=5, h_dots=5, camera_fov_degrees=DEFAULT_CAMERA_FOV_DEGREES, drone_height=100):
...
def dot_matrix_two_dimensional_drone(img: PIL.Image.Image, w_dots=5, h_dots=5, camera_fov_degrees=DEFAULT_CAMERA_FOV_DEGREES, drone_height=100):
    ...
    points = compute_grid_points(
        width, height,
        w_dots=w_dots, h_dots=h_dots,
        camera_fov_degrees=camera_fov_degrees, drone_height=drone_height,
    )
