...
class MissionControl:
    def __init__(self):
        ...
        self.prompt_manager = FlySearchPromptHelper(        # e.g. prompt generating.
            self.config,
        ...
        commands = {
            ...
            "send_to_vlm":      lambda c, a: self.vlm.handle_analyze_photo(),
            ...
            "add_warning":      lambda c, a: self.vlm.handle_analyze_photo(
                                    is_warning=True
                                ),
        ...
        try:
            ...
            while (ret in [ActionStatus.CONFIRMED, ActionStatus.WARNING]
                ...
                if not self.mission_context.parsed_response:
                    ...
                    # Send it to vlm.
                    await self.vlm.handle_analyze_photo(is_warning=(ret == ActionStatus.WARNING))
